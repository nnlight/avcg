...
graph_entry     : graph_attribute       { $$ = T_graph_attribute($1,yylocate(@1));  }
                | node_defaults         { $$ = T_node_defaults($1,yylocate(@1));    }
                | edge_defaults         { $$ = T_edge_defaults($1,yylocate(@1));    }
                | foldnode_defaults     { $$ = T_foldnode_defaults($1,yylocate(@1));}
                | foldedge_defaults     { $$ = T_foldedge_defaults($1,yylocate(@1));}
                | graph                 { $$ = T_graph($1,yylocate(@1));            }
                | node                  { $$ = T_node($1,yylocate(@1));             }
                | edge                  { $$ = T_edge($1,yylocate(@1));             }
                | nearedge              { $$ = T_near_edge($1,yylocate(@1));        }
                | bentnearedge          { $$ = T_bent_near_edge($1,yylocate(@1));   }
                | backedge              { $$ = T_back_edge($1,yylocate(@1));        }
                | constraint            { $$ = T_constraint($1,yylocate(@1));       }
                ;
...
graph_attribute : LEXWORD_TITLE ':' str_const
                ...
                | 'x' ':' int_const     { $$ = T_xdef($3,yylocate(@1));               }
                | 'y' ':' int_const     { $$ = T_ydef($3,yylocate(@1));               }
                ...
                | LEXWORD_NONEAREDGES   { $$ = T_nonearedges(yylocate(@1));           }
...
enum_color      : LEXWORD_AQUAMARINE    { $$ = T_aquamarine(yylocate(@1));   }
                | LEXWORD_BLACK         { $$ = T_black(yylocate(@1));        }
                | LEXWORD_BLUE          { $$ = T_blue(yylocate(@1));         }
                | LEXWORD_CYAN          { $$ = T_cyan(yylocate(@1));         }
                | LEXWORD_DARKBLUE      { $$ = T_darkblue(yylocate(@1));     }
                | LEXWORD_DARKCYAN      { $$ = T_darkcyan(yylocate(@1));     }
                | LEXWORD_DARKGREEN     { $$ = T_darkgreen(yylocate(@1));    }
                | LEXWORD_DARKGREY      { $$ = T_darkgrey(yylocate(@1));     }
                | LEXWORD_DARKMAGENTA   { $$ = T_darkmagenta(yylocate(@1));  }
                | LEXWORD_DARKRED       { $$ = T_darkred(yylocate(@1));      }
                | LEXWORD_DARKYELLOW    { $$ = T_darkyellow(yylocate(@1));   }
                | LEXWORD_GOLD          { $$ = T_gold(yylocate(@1));         }
                | LEXWORD_GREEN         { $$ = T_green(yylocate(@1));        }
                | LEXWORD_KHAKI         { $$ = T_khaki(yylocate(@1));        }
                | LEXWORD_LIGHTBLUE     { $$ = T_lightblue(yylocate(@1));    }
                | LEXWORD_LIGHTCYAN     { $$ = T_lightcyan(yylocate(@1));    }
                | LEXWORD_LIGHTGREEN    { $$ = T_lightgreen(yylocate(@1));   }
                | LEXWORD_LIGHTGREY     { $$ = T_lightgrey(yylocate(@1));    }
                | LEXWORD_LIGHTMAGENTA  { $$ = T_lightmagenta(yylocate(@1)); }
                | LEXWORD_LIGHTRED      { $$ = T_lightred(yylocate(@1));     }
                | LEXWORD_LIGHTYELLOW   { $$ = T_lightyellow(yylocate(@1));  }
                | LEXWORD_LILAC         { $$ = T_lilac(yylocate(@1));        }
                | LEXWORD_MAGENTA       { $$ = T_magenta(yylocate(@1));      }
                | LEXWORD_ORANGE        { $$ = T_orange(yylocate(@1));       }
                | LEXWORD_ORCHID        { $$ = T_orchid(yylocate(@1));       }
                | LEXWORD_PINK          { $$ = T_pink(yylocate(@1));         }
                | LEXWORD_PURPLE        { $$ = T_purple(yylocate(@1));       }
                | LEXWORD_RED           { $$ = T_red(yylocate(@1));          }
                | LEXWORD_TURQUOISE     { $$ = T_turquoise(yylocate(@1));    }
                | LEXWORD_WHITE         { $$ = T_white(yylocate(@1));        }
                | LEXWORD_YELLOW        { $$ = T_yellow(yylocate(@1));       }
                | LEXWORD_YELLOWGREEN   { $$ = T_yellowgreen(yylocate(@1));  }
                | int_const             { $$ = T_colindex($1,yylocate(@1));  }
                ;


enum_topsort    : LEXWORD_HIGH          { $$ = T_high(yylocate(@1));         }
                | LEXWORD_LOW           { $$ = T_low(yylocate(@1));          }
                ;


enum_orientation: LEXWORD_TOP_TO_BOTTOM { $$ = T_top_to_bottom(yylocate(@1)); }
                | LEXWORD_BOTTOM_TO_TOP { $$ = T_bottom_to_top(yylocate(@1)); }
                | LEXWORD_LEFT_TO_RIGHT { $$ = T_left_to_right(yylocate(@1)); }
                | LEXWORD_RIGHT_TO_LEFT { $$ = T_right_to_left(yylocate(@1)); }
                ;


enum_layoutalgorithm:
                  LEXWORD_BARYCENTER    { $$ = T_barycenter(yylocate(@1));    }
                | LEXWORD_ISI           { $$ = T_isi(yylocate(@1));           }
                | LEXWORD_PLANAR        { $$ = T_planar(yylocate(@1));        }
                | LEXWORD_CONSTRAINTS   { $$ = T_constaints(yylocate(@1));    }
                | LEXWORD_TREE          { $$ = T_tree(yylocate(@1));          }
                | LEXWORD_MAXDEPTH      { $$ = T_maxdepth(yylocate(@1));      }
                | LEXWORD_MINDEPTH      { $$ = T_mindepth(yylocate(@1));      }
                | LEXWORD_MAXDEPTHSLOW  { $$ = T_maxdepthslow(yylocate(@1));  }
                | LEXWORD_MINDEPTHSLOW  { $$ = T_mindepthslow(yylocate(@1));  }
                | LEXWORD_MAXDEGREE     { $$ = T_maxdegree(yylocate(@1));     }
                | LEXWORD_MINDEGREE     { $$ = T_mindegree(yylocate(@1));     }
                | LEXWORD_MAXINDEGREE   { $$ = T_maxindegree(yylocate(@1));   }
                | LEXWORD_MININDEGREE   { $$ = T_minindegree(yylocate(@1));   }
                | LEXWORD_MAXOUTDEGREE  { $$ = T_maxoutdegree(yylocate(@1));  }
                | LEXWORD_MINOUTDEGREE  { $$ = T_minoutdegree(yylocate(@1));  }
                | LEXWORD_MINBACK       { $$ = T_minbackwards(yylocate(@1));  }
                | LEXWORD_DFS           { $$ = T_depthfirst(yylocate(@1));    }
                ;


enum_layoutfrequency:
                  LEXWORD_EVERY         { $$ = T_every(yylocate(@1));    }
                | LEXWORD_MANUAL        { $$ = T_manual(yylocate(@1));   }
                ;


enum_status     : LEXWORD_BLACK         { $$ = T_black(yylocate(@1));    }
                | LEXWORD_GREY          { $$ = T_grey(yylocate(@1));     }
                | LEXWORD_WHITE         { $$ = T_white(yylocate(@1));    }
                ;


enum_yes_no     : LEXWORD_YES           { $$ = T_yes(yylocate(@1));              }
                | LEXWORD_NO            { $$ = T_no(yylocate(@1));               }
                ;

enum_cross_weight : LEXWORD_BARY        { $$ = T_bary(yylocate(@1));         }
                  | LEXWORD_MEDIAN      { $$ = T_median(yylocate(@1));       }
                  | LEXWORD_BARYMEDIAN  { $$ = T_barymedian(yylocate(@1));   }
                  | LEXWORD_MEDIANBARY  { $$ = T_medianbary(yylocate(@1));   }
                  ;

enum_view       : LEXWORD_CFISH         { $$ = T_cfish(yylocate(@1));    }
                | LEXWORD_FCFISH        { $$ = T_fcfish(yylocate(@1));   }
                | LEXWORD_PFISH         { $$ = T_pfish(yylocate(@1));    }
                | LEXWORD_FPFISH        { $$ = T_fpfish(yylocate(@1));   }
                ;

enum_arrow_mode : LEXWORD_FIXED         { $$ = T_fixed(yylocate(@1));         }
                | LEXWORD_FREE          { $$ = T_free(yylocate(@1));          }
                ;
...
enum_textmode   : LEXWORD_CENTER        { $$ = T_center(yylocate(@1));        }
                | LEXWORD_LEFT_JUSTIFY  { $$ = T_left_justify(yylocate(@1));  }
                | LEXWORD_RIGHT_JUSTIFY { $$ = T_right_justify(yylocate(@1)); }
                ;

enum_shape      : LEXWORD_BOX           { $$ = T_box(yylocate(@1));      }
                | LEXWORD_RHOMB         { $$ = T_rhomb(yylocate(@1));    }
                | LEXWORD_ELLIPSE       { $$ = T_ellipse(yylocate(@1));  }
                | LEXWORD_TRIANGLE      { $$ = T_triangle(yylocate(@1)); }
                ;

enum_node_align : LEXWORD_BOTTOM        { $$ = T_bottom(yylocate(@1)); }
                | LEXWORD_TOP           { $$ = T_top(yylocate(@1));    }
                | LEXWORD_CENTER        { $$ = T_center(yylocate(@1)); }
                ;

enum_iconstyle  : LEXWORD_BOTTOM        { $$ = T_bottom(yylocate(@1)); }
                | LEXWORD_TOP           { $$ = T_top(yylocate(@1));    }
                | LEXWORD_AROUND        { $$ = T_around(yylocate(@1)); }
                ;
...
enum_linestyle  : LEXWORD_CONTINUOUS    { $$ = T_continuous(yylocate(@1)); }
                | LEXWORD_SOLID         { $$ = T_continuous(yylocate(@1)); }
                | LEXWORD_DOTTED        { $$ = T_dotted(yylocate(@1));     }
                | LEXWORD_DASHED        { $$ = T_dashed(yylocate(@1));     }
                | LEXWORD_INVISIBLE     { $$ = T_invisible(yylocate(@1));  }
                ;


enum_arrowstyle : LEXWORD_NONE          { $$ = T_none(yylocate(@1));      }
                | LEXWORD_LINE          { $$ = T_line(yylocate(@1));      }
                | LEXWORD_SOLID         { $$ = T_solid(yylocate(@1));     }
                ;
...
string_array    : string_array str_const
                ...
                | str_const             { $$ = T_string_array(NULL,$1,yylocate(@1));  }
                ;

enum_name       : LEXWORD_EQUAL         { $$ = T_equal(yylocate(@1));            }
                | LEXWORD_SMALLER       { $$ = T_smaller(yylocate(@1));          }
                | LEXWORD_GREATER       { $$ = T_greater(yylocate(@1));          }
                | LEXWORD_NEIGHBORS     { $$ = T_neighbors(yylocate(@1));        }
                | LEXWORD_LOW_MARGIN    { $$ = T_low_margin(yylocate(@1));       }
                | LEXWORD_HIGH_MARGIN   { $$ = T_high_margin(yylocate(@1));      }
                | LEXWORD_RANGE         { $$ = T_xrange(yylocate(@1));           }
                | LEXWORD_CLUSTER       { $$ = T_cluster(yylocate(@1));          }
                | LEXWORD_LIMIT         { $$ = T_limit(yylocate(@1));            }
                | LEXWORD_ABOVE         { $$ = T_above(yylocate(@1));            }
                | LEXWORD_BELOW         { $$ = T_below(yylocate(@1));            }
                | LEXWORD_LEFT          { $$ = T_left(yylocate(@1));             }
                | LEXWORD_RIGHT         { $$ = T_right(yylocate(@1));            }
                | LEXWORD_IN_FRONT      { $$ = T_in_font(yylocate(@1));          }
                | LEXWORD_BEHIND        { $$ = T_behind(yylocate(@1));           }
                | LEXWORD_EQUAL_POSITION{ $$ = T_equal_position(yylocate(@1));   }
                | LEXWORD_EQUAL_ROW     { $$ = T_equal_row(yylocate(@1));        }
                | LEXWORD_EQUAL_COLUMN  { $$ = T_equal_column(yylocate(@1));     }
                | LEXWORD_TOP_MARGIN    { $$ = T_top_margin(yylocate(@1));       }
                | LEXWORD_BOTTOM_MARGIN { $$ = T_bottom_margin(yylocate(@1));    }
                | LEXWORD_LEFT_MARGIN   { $$ = T_left_margin(yylocate(@1));      }
                | LEXWORD_RIGHT_MARGIN  { $$ = T_right_margin(yylocate(@1));     }
                | LEXWORD_UPPER_NEIGHBOR{ $$ = T_upper_neighbor(yylocate(@1));   }
                | LEXWORD_LOWER_NEIGHBOR{ $$ = T_lower_neighbor(yylocate(@1));   }
                | LEXWORD_LEFT_NEIGHBOR { $$ = T_left_neighbor(yylocate(@1));    }
                | LEXWORD_RIGHT_NEIGHBOR{ $$ = T_right_neighbor(yylocate(@1));   }
                ;

enum_dimension  : 'x'                   { $$ = T_x(yylocate(@1)); }
                | 'y'                   { $$ = T_y(yylocate(@1)); }
                | 'z'                   { $$ = T_z(yylocate(@1)); }
                ;

attribute_value : LEX_INT               { $$ = T_integer($1,yylocate(@1)); }
                | LEX_FLOAT             { $$ = T_float($1,yylocate(@1));   }
                | LEX_CHAR              { $$ = T_char($1,yylocate(@1));    }
                | LEX_STRING            { $$ = T_string($1,yylocate(@1));  }
                | array_value           { $$ = $1; }
                ;
...
index           : LEX_INT               { $$ = T_index_val($1,yylocate(@1));}
                ;

int_const       : LEX_INT               { $$ = T_integer($1,yylocate(@1));  }
                ;

float_const     : LEX_FLOAT             { $$ = T_float($1,yylocate(@1));    }
                ;

str_const       : LEX_STRING            { $$ = T_string($1,yylocate(@1));   }
                ;
